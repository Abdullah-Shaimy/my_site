...
export default function Navbar() {
  ...
  return (
    <>
      <button
        className="sidebar__open-btn desktop-hidden"
      ...
      <aside className={`sidebar ${mobileOpen ? "open" : ""}`}>
        <div className="sidebar__brand">
          <Link href="/" className="sidebar__brand-link" onClick={() => setMobileOpen(false)}>
            <Image
              src="/logo.png"
              alt="Logo"
              width={40}
            ...
            />
            <span className="sidebar__brand-name">Abdullah</span>
          </Link>
          <button
            className="sidebar__toggle mobile-only"
